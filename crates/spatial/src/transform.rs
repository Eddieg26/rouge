use ecs::{
    ...
    task::{num_cpus, ScopedTaskPool},
    world::{
        builtin::components::{Children, Parent},
        cell::WorldCell,
...
pub fn update_transforms(
    ...
    let mut scoped = ScopedTaskPool::new(num_cpus());
...
fn update_child_transforms(children: &Children, parent: &Transform, world: &World) {
