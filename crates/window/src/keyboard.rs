    ...
    fn from(key: winit::keyboard::PhysicalKey) -> Self {
        match key {
            winit::keyboard::PhysicalKey::Unidentified(code) => match code {
                winit::keyboard::NativeKeyCode::Unidentified => Self::Unknown,
                winit::keyboard::NativeKeyCode::Android(code) => {
                    Self::Native(NativeKeyCode::Android(code))
                }
                winit::keyboard::NativeKeyCode::MacOS(code) => {
                    Self::Native(NativeKeyCode::MacOS(code))
                }
                winit::keyboard::NativeKeyCode::Windows(code) => {
                    Self::Native(NativeKeyCode::Windows(code))
                }
                winit::keyboard::NativeKeyCode::Xkb(code) => Self::Native(NativeKeyCode::Xkb(code)),
            },
