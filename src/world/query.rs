...
//     core::{component::{Component, ComponentId}, entity::Entity},
//     system::{SystemArg, WorldAccess},
// };
...
//     fn init<'a>(_: &'a WorldCell<'a>, _: &mut QueryState) {}
...
//     fn init(world: &WorldCell, state: &mut QueryState) {
//         let id = ComponentId::of::<C>();
//         #[cfg(debug_assertions)]
//         {
//             let index = world.get().registry().index_of(&*id);
//             if !world.get().access().read(index) {
//                 let meta = world.get().registry().get(&*id);
...
//     fn access() -> Vec<WorldAccess> {
//         vec![WorldAccess::new(
//             WorldAccessType::Component(ComponentId::of::<C>()),
//             Access::Read,
//         )]
//     }
// }
